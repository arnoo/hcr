...
(with-open-file (f ref-file :element-type 'character
		            :direction :output
			    :if-exists :supersede
...
(repair-file broken-file original-metadata broken-file)

(assert (file-errors broken-file original-metadata))

(repair-file broken-file original-metadata ref-file)
